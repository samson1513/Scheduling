...
import com.am.scheduling.presentation.screens.home.management.teacher.list.adapter.TeachersAdapter;
 ...
 * on 31.05.2018.
 */
public class TeacherPickerDialog extends BottomSheetDialogFragment
        implements HasSupportFragmentInjector, TeacherPickerContract.View {
    ...
    @Inject
    TeacherPickerContract.Presenter presenter;

    @BindView(R.id.rv_bfl_list)
    RecyclerView mRvBflList;
    private Unbinder mUnbinder;
    private PickerCallback<Teacher> callback;

    public static TeacherPickerDialog newInstance(PickerCallback<Teacher> callback) {
        TeacherPickerDialog dialog = new TeacherPickerDialog();
        dialog.setCallback(callback);
        return dialog;
    }

    public void setCallback(PickerCallback<Teacher> callback) {
    ...
    @Override
    public void setItems(List<TeacherDH> items) {
        adapter.setNewData(items);
    }

    @Override
    public void finishWithResult(Teacher teacher) {
