...
public class CreatorFragment extends BaseFragment<CreatorContract.Presenter>
        implements CreatorContract.View {

    @Inject
    CreatorContract.Presenter mPresenter;
    ...
    @Override
    public CreatorContract.Presenter getPresenter() {
        return mPresenter;
    }
