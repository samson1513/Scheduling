...
public class Individual {
	 ...
	 * 
	 * Given the fixed information in a Timetable, we createGroup a chromosome that
	 ...
	 * createGroup a valid chromosome for a list of cities for the TSP, by using each
	 * city once and only once.
	 * 
	 * If used in Chapter 5, however, this will createGroup an utterly INVALID
	 * chromosome for the class scheduler. So you should not use this
	 * constructor if you hope to createGroup a valid random individual. For that
	 * purpose, use the Individual(Timetable) constructor, which will createGroup a
